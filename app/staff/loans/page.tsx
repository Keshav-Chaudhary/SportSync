...
import { LoanManagement } from '@/components/staff/loan-management'
      ...
      <main className="relative z-10 p-4 md:p-8 space-y-4 md:space-y-8 max-w-[1600px] mx-auto w-full max-w-[100vw]">
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 fill-mode-both pt-4 md:pt-0">
          <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-foreground flex items-center gap-3">
            <div className="p-2 bg-primary/10 rounded-lg"><ClipboardList className="w-5 h-5 md:w-6 md:h-6 text-primary" /></div>
            Loan Management
          </h2>
          <p className="text-sm md:text-base text-muted-foreground mt-2">
            Approve requests, process returns, and monitor overdue equipment loans.
          </p>
        </div>

        <div className="grid gap-6 lg:grid-cols-1 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 fill-mode-both w-full">
